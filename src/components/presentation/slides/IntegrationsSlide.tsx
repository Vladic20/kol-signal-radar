    ...
    <div className="w-full max-w-6xl mx-auto space-y-6">
      ...
      <div className="grid md:grid-cols-2 gap-6">
        <div className="glass-effect p-5 rounded-xl border border-white/10 hover:border-neon-green/30 transition-all duration-300">
          ...
          <h3 className="text-lg font-semibold text-white mb-2 text-center">TradingView</h3>
        ...
        <div className="glass-effect p-5 rounded-xl border border-white/10 hover:border-neon-purple/30 transition-all duration-300">
          ...
          <h3 className="text-lg font-semibold text-white mb-2 text-center">CoinGecko API</h3>
      ...
      <div className="glass-effect p-6 rounded-2xl border border-neon-purple/30 bg-gradient-to-r from-neon-purple/10 to-neon-blue/10">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          <div>
            <h4 className="text-md font-semibold text-white mb-3">API подключения</h4>
            <div className="space-y-2">
              <div className="flex items-center space-x-2">
              ...
              <div className="flex items-center space-x-2">
                <div className="w-2 h-2 rounded-full bg-neon-green"></div>
                <span className="text-gray-300 text-sm">Автоматическое переподключение</span>
              </div>
            </div>
          </div>
          <div>
            <h4 className="text-md font-semibold text-white mb-3">Безопасность</h4>
            <div className="space-y-2">
              <div className="flex items-center space-x-2">
              ...
              <div className="flex items-center space-x-2">
                <div className="w-2 h-2 rounded-full bg-neon-blue"></div>
                <span className="text-gray-300 text-sm">Ограничения по IP адресам</span>
              </div>
              <div className="flex items-center space-x-2">
                <div className="w-2 h-2 rounded-full bg-neon-blue"></div>
      ...
      <div className="text-center">
        <div className="inline-flex items-center px-4 py-2 glass-effect rounded-full border border-neon-purple/30">
          <span className="text-white font-medium text-sm">Планируется добавить: OKX, Kraken, Huobi, Gate.io, KuCoin, Bitget</span>
        </div>
      </div>
    </div>
  );
