...
const MobileProfilePage = () => {
  ...
  return (
    <div className="pb-20 pt-16 px-4 bg-background min-h-screen">
      {/* Profile Header */}
      <div className="mb-6">
          ...
          <div className="flex items-center space-x-4">
            ...
            <div>
              ...
              <div className="flex items-center space-x-2 mt-1">
                ...
                <span className="text-sm text-neon-purple">💠 {userStats.kolPoints}</span>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="space-y-4">
            <Card className="glass-effect border-white/10">
              <CardContent className="p-4">
                <h3 className="font-semibold text-white mb-3">Активность за месяц</h3>
            ...
            <Card className="glass-effect border-white/10">
              <CardContent className="p-4">
                <h3 className="font-semibold text-white mb-3">Достижения</h3>
                <div className="grid grid-cols-2 gap-3">
                  <div className="text-center">
                    <Trophy className="w-8 h-8 text-yellow-400 mx-auto mb-2" />
                    <div className="text-sm text-gray-400">Первый пост</div>
                  </div>
                  <div className="text-center">
                    <Users className="w-8 h-8 text-blue-400 mx-auto mb-2" />
                    <div className="text-sm text-gray-400">10 подписчиков</div>
                  </div>
                </div>
              </CardContent>
            </Card>
